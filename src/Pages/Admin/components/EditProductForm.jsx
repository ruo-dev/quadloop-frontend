...
export const EditProductForm = ({ categories }) => {
  ...
  useEffect(() => {
    if (product) {
      ...
      const productImages = Object.values(product?.product_images ?? {})
        .map((image, index) => ({
          file: { path: image },
          url: image,
        }))
    ...
    <div className="relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col">
                ...
                {images.length > 0 && (
                  <small className="my-3 text-gray-600">
                    Remove all images to upload new images
                  </small>
                )}
                <input
                  type="file"
        ...
        <div className="flex flex-col gap-4 p-4 bg-white rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-gray-600">Regular Price</label>
              <input
                className="bg-gray-200 w-full rounded p-2"
                type="number"
                value={regularPrice}
        ...
        <div className="flex flex-col gap-4 p-4 bg-white rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-gray-600">Product Tags</label>
              <TagInput
                tags={tags}
