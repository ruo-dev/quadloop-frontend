...
export const ProductForm = ({ categories, getProducts }) => {
  ...
  return (
    <div className="relative">
      ...
      <form onSubmit={handleSubmit} className="h-[650px] flex flex-col">
        ...
        <div className="flex items-center gap-3 p-2">
          <div className="border flex-[3] h-[250px] bg-white rounded-md p-4">
            <h2 className="font-semibold text-gray-700 text-xl">Pricing</h2>
            <div className="">
              <div className="mt-4">
          ...
          <div className="border flex-[2] bg-white rounded-md p-4">
            <h2 className="font-semibold text-gray-700 text-xl">Category</h2>
            <div className="mt-4">
              ...
              <select
                ...
                required
              >
                <option value="" disabled className="py-2 px-4 text-gray-500">
                  Select a category
                </option>
              ...
              <div className="mt-4">
                <label className="block">Product Tags</label>
        ...
        <div className="p-2">
          <div className="border bg-white rounded-md p-4">
            <h2 className="font-semibold text-gray-700 text-xl">Inventry</h2>
